...
const TeamPage = () => {
    ...
    const members = [
        { name: "Amrita Jha", role: "CEO", img: "image/amrita.jpeg" },
        ...
        <section className="pt-40 pb-20">
            <div className="container mx-auto px-6 text-center justify-center">
                ...
                <div className="flex justify-center ">
                        ...
                        <div  className="bg-white p-8 rounded-[40px] shadow-lg border border-slate-50 group hover:-translate-y-2 transition-transform">
                            <div className="relative w-32 h-32 mx-auto mb-6">
                                <img src="image/amrita.jpeg" alt="Amrita Jha" className="w-full h-full rounded-full object-cover ring-4 ring-emerald-50" />
                                <div className="absolute bottom-0 right-0 bg-emerald-700 p-2 rounded-full text-white">
                                    <MessageCircle size={16} />
                                </div>
                            </div>
                            <h3 className="font-bold text-xl mb-1">Amrita Jha</h3>
                            <p className="text-slate-500 text-sm mb-4">CEO</p>
